...
function getOpenServiceRequestsForWorker(workerId, filters = {}) {
  ...
  // ⚡ Bolt: Use a single for...of loop and apply filters early to prevent redundant data normalization
  // and expensive operations on items that will be filtered out.
...
function getWorkerMatchesForRestaurant(restaurantId, filters = {}) {
  ...
  // ⚡ Bolt: Apply filters early before performing expensive operations like buildPairMetrics
