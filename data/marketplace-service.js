...
function getOpenServiceRequestsForWorker(workerId, filters = {}) {
  ...
  // Applica prima i filtri di base per evitare di migliorare annunci non necessari
  ...
  // Filtra per zona ristorante (richiede che il ristorante sia stato ottenuto)
...
function getWorkerMatchesForRestaurant(restaurantId, filters = {}) {
  ...
  // Applica prima i filtri di base per evitare di migliorare worker non necessari
  ...
  // Nota: qualifica è complessa perché verifica anche hardSkills aggiunte da getEnhancedWorker,
  // ma filter base su qualifiche di base può ottimizzare
  ...
  // Riapplica il filtro qualifica dopo l'enhancement per includere hardSkills e qualifiche pulite
